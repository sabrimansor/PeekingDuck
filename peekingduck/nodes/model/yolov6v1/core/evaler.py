...
from peekingduck.nodes.model.yolov6v1.utils.events import LOGGER, NCOLS
from peekingduck.nodes.model.yolov6v1.utils.nms import non_max_suppression
from peekingduck.nodes.model.yolov6v1.utils.checkpoint import load_checkpoint
from peekingduck.nodes.model.yolov6v1.utils.torch_utils import time_sync, get_model_info
...
class Evaler:
    ...
    def init_model(self, model, weights, task):
        if task != 'train':
            ...
            # switch to deploy
            from peekingduck.nodes.model.yolov6v1.layers.common import RepVGGBlock
