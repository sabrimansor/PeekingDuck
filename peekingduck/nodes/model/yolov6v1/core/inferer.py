...
from peekingduck.nodes.model.yolov6v1.utils.events import LOGGER, load_yaml
from peekingduck.nodes.model.yolov6v1.layers.common import DetectBackend
...
from peekingduck.nodes.model.yolov6v1.utils.torch_utils import get_model_info


class Inferer:
    def __init__(self, source, weights, device, yaml, img_size, half):
        import glob
        from peekingduck.nodes.model.yolov6v1.data.datasets import IMG_FORMATS
